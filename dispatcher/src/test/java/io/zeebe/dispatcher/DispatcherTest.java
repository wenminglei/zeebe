...
public final class DispatcherTest {
  ...
  public void shouldIncrementRecordPositionAfterClaimingFragment() {
    ...
    // then
    assertThat(newPosition).isEqualTo(INITIAL_POSITION);
    newPosition = dispatcher.claim(claimedFragment, A_MSG_PAYLOAD_LENGTH, A_STREAM_ID);
  ...
  public void shouldIncreasePositionByFragmentCountAfterClaimingBatch() {
    ...
    // when
    long newPosition = dispatcher.claim(claimedFragmentBatch, fragmentCount, A_MSG_PAYLOAD_LENGTH);

    // then
    assertThat(newPosition).isEqualTo(INITIAL_POSITION);
    newPosition = dispatcher.claim(claimedFragmentBatch, fragmentCount, A_MSG_PAYLOAD_LENGTH);
